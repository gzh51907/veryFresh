<template>
  <div class="detail">
    ...
    <div class="del_con">
      ...
      <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign" style="padding-bottom:100px;">
    ...
    <div class="del_car">
       ...
       <div class="car_shop">
          <div class="shop_left">
            <a href="#"><van-icon name="like-o"/></a>
            <a href="#"><van-icon name="service-o"/></a>
            <a href="#"><van-icon name="cart-o"/></a>
          </div>
          <div class="shop_right">
             <div class="shop_flex">
                    加入购物车
             </div>
             <div class="shop_flex now_shop">
                    立即购买
             </div>
          </div>
       </div>
